...
public class Basic extends GLJPanel implements GLEventListener {
	...
	private Boolean loadModels(GL2 gl) {
		...
		chairModel=new GOL(gl, "./Objs/", "./Objs/", "./Objs/");
		x=chairModel.golLoad("dozer.obj", "dozer.mtl");
...
//				gl.glPopMatrix();
	...
	public static void main(String[] args) {
		...
		window.getContentPane().add(new Basic());
